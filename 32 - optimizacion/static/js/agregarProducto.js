...
function mostrarFormularioEdicion(producto, formContainer) {
    ...
    formEdicion.innerHTML = `
        ...
        <div class="form-group">
            <label>Title:</label>
            <input type="text" class="edit-title" value="${producto.title}" required>
        </div>
        <div class="form-group">
            <label>Description:</label>
            <input type="text" class="edit-description" value="${producto.description}" required>
        </div>
        <div class="form-group">
            <label>Price:</label>
            <input type="number" class="edit-price" value="${producto.price}" required>
        </div>
        <div class="form-group">
            <label>Thumbnail:</label>
            <input type="text" class="edit-thumbnail" value="${producto.thumbnail}" required>
        </div>
        <div class="form-group">
            <label>Stock:</label>
            <input type="number" class="edit-stock" value="${producto.stock}" required>
        </div>
        <div class="form-group">
            <label>Category:</label>
            <input type="text" class="edit-category" value="${producto.category}" required>
        </div>
        <div class="form-group">
            <label>Status:</label>
            <input type="checkbox" class="edit-status" ${producto.status ? 'checked' : ''}>
        </div>
    ...
    formEdicion.querySelector('.cancelar-edicion').addEventListener('click', () => {
        formEdicion.remove();
    });
}
